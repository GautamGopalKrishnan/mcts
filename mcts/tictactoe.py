...
class GraphicInterface2:
    ...
    def __init__(self):
        ...
        self.action_buttons = [
            Button(self.win, Point(100, 150), 50, 50, "0"),
            Button(self.win, Point(200, 150), 50, 50, "1"),
            Button(self.win, Point(300, 150), 50, 50, "2"),
            Button(self.win, Point(100, 250), 50, 50, "3"),
            Button(self.win, Point(200, 250), 50, 50, "4"),
            Button(self.win, Point(300, 250), 50, 50, "5"),
            Button(self.win, Point(100, 350), 50, 50, "6"),
            Button(self.win, Point(200, 350), 50, 50, "7"),
            Button(self.win, Point(300, 350), 50, 50, "8"),
